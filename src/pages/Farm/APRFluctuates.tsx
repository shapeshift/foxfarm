...
export const APRFluctuates = () => (
  <Text color='gray.500' fontSize='xs' maxW='460px' textAlign='center'>
    *ShapeShift is awarding 15,881,840 FOX until February 24, 2022 to liquidity providers that stake
    ...
    after FOX yield farming v2 starts
  </Text>
)
